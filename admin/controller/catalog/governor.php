...
class ControllerCatalogGovernor extends PT_Controller
{
    ...
    protected function getForm()
    {
        ...
        if (isset($this->request->post['rotarian'])) {
            $data['classification'] = $this->request->post['rotarian'];
        } elseif (!empty($governor_info)) {
    ...
    protected function validateForm()
    {
        ...
        $governor_info = $this->model_catalog_governor->getGovernorByEmail($this->request->post['email']);
        ...
        if (!isset($this->request->get['governor_id'])) {
            ...
            if ($governor_info && ($this->request->get['governor_id'] != $governor_info['governor_id'])) {
                $this->error['warning'] = $this->language->get('error_exists_email');
            }
        }
        ...
        if ($this->request->post['password'] || (!isset($this->request->get['governor_id']))) {
